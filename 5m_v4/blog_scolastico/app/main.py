...
from app.repositories.post_repository import get_post_by_id, search_posts_by_title
from app.repositories.comment_repository import get_comments_by_post
...
def search():
    ...
    if request.method == 'POST':
        ...
        parola_cercata = request.form.get("parola_cercata")
        posts = search_posts_by_title(parola_cercata)
        return render_template('search_results.html', posts=posts,search=parola_cercata)