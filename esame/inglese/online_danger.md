# Verifica inglese
213-214-215-216-222-225-226-234
cybercrime glossary

---
## Online Dangers | 213

The constant connection of pc to the internet have opened enourmous activity for criminal activity.

"Malware" is a term used to describe malicous software that finds its way onto peaple's computer.

It can be spreded  via:
- E-mail,
- online service,
...
1. VIRUS
    Is a malicius program that infiltrate the PC and caouses it to malfanction as it was "ill".
2. SPYWARE
    Is a secret program that observesand reports on a user's online bhaviour, without the person knowing it,
    it may also change a computer settings or display pop up ads.
3. SPAM
    Is unwanted e-mail message trasmitted to masses of people usualy for advetising purposes.

    Sometime harmles but often they can carry a virus.
4. WORM
    Is a program that invade computers on a network and bury itself deep inside the software.
